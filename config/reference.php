 ...
 *         without_constructor?: bool, // Deprecated: Configuration "zenstruck_foundry.instantiator.without_constructor" is deprecated and will be removed in 2.0. Use "zenstruck_foundry.instantiator.use_constructor" instead. // Whether or not to call an object's constructor during instantiation.
 *         use_constructor?: bool, // Use the constructor to instantiate objects.
 ...
 *             mode?: "schema"|"migrate", // Reset mode to use with ResetDatabase trait // Default: "schema"
 *         },
 *     },
 *     mongo?: array{
 *         reset?: array{
 ...
 *     },
 * }
 * @psalm-type PhpSpreadsheetConfig = array<mixed>
 * @psalm-type TzunghaorSettingsConfig = array{
 *     security?: bool, // Use security voters to check editor access. Needs symfony/security-core // Default: false
 *     collections?: array<string, array{ // Default: []
 *         mappings?: list<array{ // Default: []
 *             dir?: scalar|null, // Root directory containing setting classes
 *             prefix?: scalar|null, // Namespace prefix of the directory (with trailing \)
 *         }>,
 *         title?: scalar|null, // Title displayed in editor (default is collection name)
 *         cache?: scalar|null, // Id of a tag aware cache service to be used
 *         entity?: scalar|null, // Entity class - must implement PersistedSettingInterface
 *         scopes?: list<array{ // Default: []
 *             name: scalar|null,
 *             title?: scalar|null, // Title displayed in editor (default is scope name)
 *             children?: mixed, // Same structure recursively
 *             extra?: array<mixed>,
 *             ...<mixed>
 *         }>,
 *         default_scope?: mixed,
 *         scope_provider?: scalar|null, // Scope provider service - must implement ScopeProviderInterface
 *         extra?: array<mixed>,
 *     }>,
 * }
 ...
 *     php_spreadsheet?: PhpSpreadsheetConfig,
 *     tzunghaor_settings?: TzunghaorSettingsConfig,
