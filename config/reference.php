 ...
 *     security?: bool|Param, // Use security voters to check editor access. Needs symfony/security-core // Default: false
 *     collections?: array<string, array{ // Default: []
 *         mappings?: list<array{ // Default: []
 *             dir?: scalar|Param|null, // Root directory containing setting classes
 *             prefix?: scalar|Param|null, // Namespace prefix of the directory (with trailing \)
 *         }>,
 *         title?: scalar|Param|null, // Title displayed in editor (default is collection name)
 *         cache?: scalar|Param|null, // Id of a tag aware cache service to be used
 *         entity?: scalar|Param|null, // Entity class - must implement PersistedSettingInterface
 *         scopes?: list<array{ // Default: []
 *             name?: scalar|Param|null,
 *             title?: scalar|Param|null, // Title displayed in editor (default is scope name)
 *             children?: mixed, // Same structure recursively
 *             extra?: array<mixed>,
 *             ...<string, mixed>
 *         }>,
 *         default_scope?: mixed,
 *         scope_provider?: scalar|Param|null, // Scope provider service - must implement ScopeProviderInterface
 *         extra?: array<mixed>,
 *     }>,
 * }
